...
[Enable the Google Drive API](https://console.cloud.google.com/apis/api/drive.googleapis.com)
...
2. Run: `gdcli accounts credentials ~/path/to/credentials.json`
3. Run: `gdcli accounts add <email>` (use `--manual` for browserless OAuth)
